...
# що випали випадковим чином і в певному діапазоні під час чергового тиражу. Наприклад, необхідно вгадати шість чисел
...
def get_numbers_ticket(min, max, quantity):
    if min < 1 or max > 1000 or min > max or max - min < quantity:
        ...
        while len(random_numbers) != quantity:
            random_numbers.add(rm.randint(min,max))
...
#or
# else:
#     random_numbers = rm.sample(range(min,max+1), k = quantity)
#     random_numbers.sort()
#     return random_numbers
